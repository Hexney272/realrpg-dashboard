...
addEvent("onPremiumPointsAdded", true)
addEventHandler("onPremiumPointsAdded", root,
    function(packageName, points)
        exports.sGui:showInfobox("s", "Kaptál egy " .. packageName .. "' csomagot (" .. points .. "pp) Köszönjük a támogatást!")
    end
)
