...
addEventHandler("dashSaveColorSet", getRootElement(), function()
	...
	sightexports.sGui:showInfobox("w", "A megfelelő játékélmény érdekében színséma váltás után indítsd újra a MTA klienst!")
	doColorsetTesters()
end)
